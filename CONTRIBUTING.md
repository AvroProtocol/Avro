...
Thank you for contributing to AVRO. This repository includes the web application, native clients, backend services, SDK, and smart contracts, so changes should stay focused and easy to review.
...
```bash
git clone https://github.com/AvroProtocol/Avro.git
cd Avro
bun install
```
