...
This document describes the production layout used by AVYRO.

## Website

The web application is deployed from the repository root.

- Production: `https://avyroprotocol.com`
- Docs: `https://avyroprotocol.com/docs`
...
- Production: `https://api.avyroprotocol.com`
...
```text
https://api.avyroprotocol.com/v1/downloads/android
https://api.avyroprotocol.com/v1/downloads/windows
https://api.avyroprotocol.com/v1/downloads/macos
https://api.avyroprotocol.com/v1/downloads/linux
```
