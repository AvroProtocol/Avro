      ...
      <SafeAreaProvider>
        <SafeAreaView style={styles.container} edges={["top", "left", "right", "bottom"]}>
          ...
          <View style={styles.onboardingContainer}>
            ...
            <Text style={styles.onboardingTitle}>AVRO PROTOCOL</Text>
        ...
        <View style={styles.header}>
          <View style={styles.headerBrandRow}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.headerTitle}>AVRO PROTOCOL</Text>
          </View>
                ...
                payLinks.map((link) => (
                  <View key={link.id} style={styles.payLinkCardWrap}>
                    ...
                    <View style={styles.payLinkInfo}>
                      ...
                      <Text style={styles.payLinkSlug}>avroprotocol.com/pay/{link.slug}</Text>
                    </View>
                    ...
                    <View style={styles.payLinkActions}>
                      ...
                      <TouchableOpacity
                        style={styles.payLinkActionBtn}
                        onPress={() =>
                          copyToClipboard(link.id, `https://avroprotocol.com/pay/${link.slug}`)
                        }
                      >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          Share.share({
                            message: `Pay ${link.amount} ${link.token} privately on Robinhood Chain: https://avroprotocol.com/pay/${link.slug}`,
                          })
                        }
                      >
                    ...
                    {expandedQrSlug === link.slug && (
                      <View style={styles.payLinkQrPanel}>
                        <View style={styles.payLinkQrWrapper}>
                          <QRCode
                            value={`https://avroprotocol.com/pay/${link.slug}`}
                            size={150}
                            color="#000000"
              ...
              {settingsSubPage === null ? (
                <>
                  ...
                  <View style={styles.settingsFooterBox}>
                    <Text style={styles.settingsFooterText}>Avro Protocol Mobile v0.1.14</Text>
                    ...
                    <>
                      ...
                      <View style={styles.card}>
                        ...
                        <View style={styles.networkSpecRow}>
                          ...
                          <TouchableOpacity
                            onPress={() => copyToClipboard("factory-ca", AVRO_FACTORY_ADDRESS)}
                            style={styles.drawerCaCopyRow}
                          >
                            <Text style={styles.drawerCaText}>
                              {shortenAddress(AVRO_FACTORY_ADDRESS)}
                            </Text>
