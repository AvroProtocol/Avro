...
--
-- AVRO has thin liquidity (~$4.8k), which makes spot price cheap to move. A
...
ALTER TABLE rebate_claims
  ADD COLUMN IF NOT EXISTS avro_price_source VARCHAR(24) NOT NULL DEFAULT 'configured',
  ADD COLUMN IF NOT EXISTS avro_reference_price NUMERIC(38, 18),
