...
export const AVRO_TOKEN_ADDRESS: Address = (import.meta.env.VITE_AVRO_TOKEN_ADDRESS?.trim() || "") as Address;
export const AVRO_TOKEN_CONFIGURED = /^0x[0-9a-fA-F]{40}$/.test(AVRO_TOKEN_ADDRESS);

export const TOKENS: TokenInfo[] = [
  ...(AVRO_TOKEN_CONFIGURED ? [{
    symbol: "AVRO",
    name: "Avro Protocol",
