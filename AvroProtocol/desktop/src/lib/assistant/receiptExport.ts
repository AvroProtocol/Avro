/**
 * Verifiable Receipt Export & Offline Verifier - Avro Protocol v0.1.20
 *
 * Turns an InferenceReceipt into a self-contained, optionally signed bundle that
 * a third party can check WITHOUT trusting Avro Protocol.
 *
...
export const RECEIPT_BUNDLE_FORMAT = "avro-receipt/1";
 ...
 * preimage attack.
 */
export const RECEIPT_DOMAIN_TAG = "AVRO-INFERENCE-RECEIPT-v1\n";
...
export function receiptBundleFilename(receipt: InferenceReceipt): string {
  return `avro-inference-receipt-${receipt.shortRef}.json`;
}
