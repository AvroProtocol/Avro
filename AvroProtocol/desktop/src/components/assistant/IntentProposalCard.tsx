...
export const IntentProposalCard: React.FC<IntentProposalCardProps> = ({
  ...
  if (intent.type === "send_transfer") {
    ...
    return (
      <div className={`mt-3 rounded-xl border p-3.5 text-xs transition-colors ${
        isDanger ? "border-[#ffffff]/40 bg-[#ffffff]/10" : "border-white/10 bg-white/[0.04]"
      }`}>
        ...
        <div className="space-y-1.5 mb-3 text-white/80">
          ...
          {safetyEvidence?.guardrailVerdict && (
            <div className="flex items-center justify-between">
              ...
              <span className={safetyEvidence.guardrailVerdict === "blocked" ? "text-[#ffffff] font-semibold" : "text-white/70"}>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg font-medium text-white bg-[#ffffff] hover:bg-[#d4d4d4] transition-colors"
          >
  ...
  if (intent.type === "create_paylink") {
    return (
      <div className="mt-3 rounded-xl border border-white/10 bg-white/[0.04] p-3.5 text-xs">
        <div className="flex items-center justify-between gap-2 mb-2 pb-2 border-b border-white/5">
          <div className="flex items-center gap-1.5 font-medium text-white">
            <Link2 className="h-3.5 w-3.5 text-[#ffffff]" />
  ...
  if (intent.type === "panic_freeze") {
    return (
      <div className="mt-3 rounded-xl border border-[#ffffff]/40 bg-[#ffffff]/10 p-3.5 text-xs">
        <div className="flex items-center justify-between gap-2 mb-2 pb-2 border-b border-[#ffffff]/20">
