...
const KEY_ACTIVE_ACCOUNT = "avro_active_account";
const KEY_PREFIX_SHARD_A = "avro_shard_a_";
const KEY_PREFIX_GUARDRAILS = "avro_guardrails_";
const KEY_PREFIX_CONTACTS = "avro_contacts_";
