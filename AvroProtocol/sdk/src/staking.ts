...
/**
 * Record a completed $AVRO stake transaction with the backend
 */
 ...
 */
export async function renewStaking(wallet: AvroWallet): Promise<any> {
...
/**
 * Request unstaking of $AVRO back to user wallet
 */
export async function unstakeAvro(params: {
  wallet: AvroWallet;
  amount: number;
}): Promise<any> {
