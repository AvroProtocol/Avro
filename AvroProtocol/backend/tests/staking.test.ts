...
describe("Staking Tier Model", () => {
  it("correctly identifies non-eligible stakes under 10,000 AVRO", () => {
  ...
  it("calculates Tier 1 for 10k to <50k AVRO (25 txns/month)", () => {
  ...
  it("calculates Tier 2 for 50k AVRO (100 txns/month)", () => {
  ...
  it("awards Unlimited transactions for >= 1,000,000 AVRO", () => {
