...
export const Route = createFileRoute("/avro")({
  component: AvroCoinPage,
  head: () => ({
    meta: [
      { title: "$AVRO | Avro Protocol" },
      { name: "description", content: "Official $AVRO page for Avro Protocol with launch access, contract verification, and official links." },
    ],
  }),
});
      ...
      <main>
        <section className="nx-coin-hero">
          ...
          <div className="nx-container nx-coin-layout">
            <div className="nx-coin-copy" data-reveal>
              ...
              <div className="nx-live-pill nx-live-pill-dark"><i className={live ? "is-live" : ""}/><span>AVRO ECOSYSTEM</span><b>{live ? "CONTRACT LIVE" : "COMING SOON"}</b></div>
              <h1><span>$</span>{config.ticker}</h1>
              <p>The official home for $AVRO launch access, verified contract information, and Avro-controlled ecosystem links.</p>
            ...
            <div className="nx-token-sculpture" data-reveal aria-label="$AVRO token visualization">
              <div className="nx-sculpture-orbit nx-so1"/><div className="nx-sculpture-orbit nx-so2"/><div className="nx-sculpture-orbit nx-so3"/>
              <div className="nx-sculpture-disc"><img src="/assets/avro-mark-black.png" alt=""/><span>AVRO</span></div>
        ...
        <section className="nx-section nx-coin-contract">
          <div className="nx-container">
            ...
            <div className="nx-coin-metrics" data-reveal>
              <article><span>01</span><small>TICKER</small><strong>${config.ticker}</strong><p>Official Avro ecosystem symbol.</p></article>
              ...
              <article><span>04</span><small>STATUS</small><strong>{live ? "Live" : "Coming soon"}</strong><p>Use Avro-controlled links for contract and launch information.</p></article>
            </div>
          </div>
        </section>
        ...
        <section className="nx-section nx-coin-story">
          <div className="nx-container nx-coin-story-layout">
            <div data-reveal><span className="nx-index">AVRO ECOSYSTEM</span><h2>One protocol.<br/>One official token page.</h2><p>$AVRO is presented separately from the wallet experience so product security, token information, and launch access stay clear and easy to verify.</p></div>
            <div className="nx-coin-steps" data-reveal>
              ...
              <article><span>02</span><div><h3>Direct launch access</h3><p>The buy action opens the official Pons launch page for the live $AVRO contract.</p></div></article>
              <article><span>03</span><div><h3>Official ecosystem links</h3><p>Use Avro-controlled X and GitHub channels for protocol and launch updates.</p></div></article>
            </div>
          </div>
        </section>
        ...
        <section className="nx-coin-final">
          <div className="nx-container" data-reveal>
            <div><span className="nx-index nx-index-dark">OFFICIAL SOURCES</span><h2>Stay connected<br/>to Avro.</h2><p>Protocol releases, developer updates, and ecosystem announcements are published through Avro-controlled channels.</p></div>
