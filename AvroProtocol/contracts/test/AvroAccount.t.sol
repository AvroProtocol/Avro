...
import {AvroAccount} from "../src/AvroAccount.sol";
import {AvroFactory} from "../src/AvroFactory.sol";
...
contract AvroAccountTest is TestBase {
    AvroAccount public account;
    AvroFactory public factory;
    ...
    function setUp() public {
        factory = new AvroFactory(entryPoint);
        account = new AvroAccount(entryPoint, shardA, shardB, shardC);
    }
    ...
    function test_FactoryPrediction() public {
        ...
        AvroAccount created = factory.createAccount(shardA, shardB, shardC, salt);
    ...
    function test_ValidTwoOfThreeSignature() public {
        ...
        AvroAccount testAcc = new AvroAccount(entryPoint, realShardA, realShardB, shardC);
    ...
    function test_WrongSignerRejected() public {
        ...
        address realShardA = vm.addr(keyA);
        AvroAccount testAcc = new AvroAccount(entryPoint, realShardA, shardB, shardC);
