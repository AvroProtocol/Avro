...
export function buildFactoryInitCode(
  ...
  factoryAddress: Address = AVRO_FACTORY_ADDRESS
): Hex {
...
/**
 * Encodes calldata for sending ETH or USDG through AvroAccount.execute
 */
...
/**
 * Submit signed UserOperation to the AVRO bundler
 */
