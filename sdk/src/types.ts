...
export interface AvyroWalletRegistration {
  address: Address;
  chainId: number;
...
export interface AvyroWalletConfig {
  address: Address;
  shardA: ILocalShard;
...
export interface BridgeQuoteRequest {
  ...
  /** Wallet that accrues Avyro's app fee with Relay. */
  appFeeRecipient?: Address;
  /** Avyro's app fee in basis points. */
  appFeeBps?: number;
}
