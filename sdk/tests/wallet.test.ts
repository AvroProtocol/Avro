...
import { AvroWallet } from "../src/wallet.js";
...
describe("AvroWallet", () => {
  ...
  it("combines two valid 65-byte signatures into 130 bytes", () => {
    const combined = AvroWallet.combineSignatures(dummySig65, dummySig65);
  ...
  it("throws when combining signatures of invalid length", () => {
    expect(() => AvroWallet.combineSignatures(dummySig65, shortSig as any)).toThrow(
