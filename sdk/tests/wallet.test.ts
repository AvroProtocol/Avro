...
import { AvyroWallet } from "../src/wallet.js";
import { LocalShard, RemoteCosigner } from "../src/shard.js";

describe("AvyroWallet", () => {
  ...
  it("combines two valid 65-byte signatures into 130 bytes", () => {
    const combined = AvyroWallet.combineSignatures(dummySig65, dummySig65);
  ...
  it("throws when combining signatures of invalid length", () => {
    expect(() => AvyroWallet.combineSignatures(dummySig65, shortSig as any)).toThrow(
