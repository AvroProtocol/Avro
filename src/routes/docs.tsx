...
export const Route = createFileRoute("/docs")({
  ...
  head: () => ({
    meta: [
      { title: "Docs | Avyro Protocol" },
      { name: "description", content: "Avyro Protocol technical documentation for threshold custody, ERC-4337 smart accounts, recovery, privacy, and the open TypeScript SDK." },
    ],
  }),
});
...
const PRIMITIVES = [
  ...
  [WalletCards, "ERC-4337 smart accounts", "Avyro prepares programmable UserOperations so account behavior can include policy checks, recovery, and gas sponsorship."],
  ...
  [Network, "Robinhood Chain", "Avyro targets Robinhood Chain with Chain ID 4663, native ETH for gas, and USDG as a core settlement asset."],
        ...
        <section className="nx-docs-hero">
          ...
          <div className="nx-container nx-docs-hero-inner">
            <div data-reveal>
              ...
              <p>Technical reference for Avyro threshold custody, smart accounts, recovery, privacy infrastructure, and developer tooling.</p>
              <div className="nx-docs-actions">
                <a className="nx-button nx-button-light" href="https://github.com/AvyroProtocol/Avyro" target="_blank" rel="noreferrer"><Github size={15}/> GitHub <ArrowUpRight size={14}/></a>
            ...
            <div className="nx-docs-terminal" data-reveal>
              <div><span/><span/><span/><b>avyro.ts</b></div>
        ...
        <section className="nx-docs-body">
          <div className="nx-container nx-docs-layout">
            <aside className="nx-docs-side" data-reveal>
              ...
              <p>Jump to the related section on the Avyro home page.</p>
            ...
            <div className="nx-docs-content">
              <section data-reveal>
                ...
                <h2>Avyro Protocol</h2>
                <p className="nx-docs-lead">Avyro is a self-custodial wallet and open developer toolkit designed around distributed signing. Funds remain controlled by a threshold smart account, while day-to-day payments can still feel like a normal application.</p>
              ...
              <section data-reveal>
                ...
                <p>The open SDK is designed to expose Avyro account and payment primitives without forcing applications to reimplement threshold orchestration.</p>
                <div className="nx-docs-code"><div><span>Package</span><code>@avyro/protocol-sdk</code></div><div><span>Repository</span><a href="https://github.com/AvyroProtocol/Avyro" target="_blank" rel="noreferrer">github.com/AvyroProtocol/Avyro <ArrowUpRight size={12}/></a></div><div><span>Network</span><code>Robinhood Chain · 4663</code></div></div>
              </section>

              <section data-reveal>
                <span className="nx-docs-kicker">06 / EXPLORE</span>
                <h2>Continue through the product.</h2>
                <p>Each technical topic maps back to an interactive section on the main Avyro experience.</p>
