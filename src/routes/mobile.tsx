...
import { AVYRO_API_URL } from "@/lib/api";
...
export const Route = createFileRoute("/mobile")({
  ...
  head: () => ({
    meta: [
      { title: "Avyro Mobile: Self-custody in your pocket" },
      { name: "description", content: "Avyro mobile wallet for Robinhood Chain with 2-of-3 threshold security, spending guardrails, passkey recovery, and disposable pay links." },
    ],
  }),
});

const API_BASE = AVYRO_API_URL;
...
function MobilePage() {
  ...
  const [release, setRelease] = useState("Latest Android release");

  useEffect(() => {
    fetch(`${API_BASE}/v1/downloads/latest`)
      .then(res => res.ok ? res.json() : null)
      .then(data => {
        if (!data) return;
        if (data.version) setRelease(`v${data.version}`);
        const direct = data.android?.directUrl || data.android?.url;
      ...
      <main>
        <section className="av-mobile-hero">
          ...
          <div className="av-container av-mobile-hero-grid">
            <div className="av-mobile-copy" data-reveal>
              <span className="av-kicker av-kicker-invert">Avyro mobile</span>
            ...
            <div className="av-phone-stage" data-reveal>
              ...
              <div className="av-phone">
                ...
                <div className="av-phone-screen">
                  <div className="av-phone-top"><img src="/assets/avyro-mark-white.png" alt=""/><span>AVYRO</span><i/></div>
        ...
        <section className="av-section">
          <div className="av-container">
            <div className="av-section-intro" data-reveal><div><span className="av-kicker">Mobile controls</span><h2>The security surface you actually need on a phone.</h2></div><p>Avyro mobile focuses on account safety and payment execution instead of shrinking a desktop dashboard into a smaller screen.</p></div>
        ...
        <section className="av-section">
          <div className="av-container av-mobile-download" data-reveal>
            <div><span className="av-kicker">Android release</span><h2>Install Avyro Mobile.</h2><p>The Android build uses the same Robinhood Chain account model as desktop and the open SDK.</p></div>
