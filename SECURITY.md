...
AVRO is a self-custodial threshold wallet and payment stack. Security reports are handled privately because vulnerabilities may affect signing, recovery, account execution, or user funds.

## Report a vulnerability

Do not open a public GitHub issue for a security vulnerability.

Email: `security@avroprotocol.com`
...
AVRO requires a 2-of-3 authorization quorum across independent security factors. A valid design must not allow one factor to spend alone.
