...
import {AvyroAccount} from "../src/AvyroAccount.sol";
import {AvyroFactory} from "../src/AvyroFactory.sol";
...
contract AvyroAccountTest is TestBase {
    AvyroAccount public account;
    AvyroFactory public factory;
    ...
    function setUp() public {
        factory = new AvyroFactory(entryPoint);
        account = new AvyroAccount(entryPoint, shardA, shardB, shardC);
    }
    ...
    function test_FactoryPrediction() public {
        ...
        AvyroAccount created = factory.createAccount(shardA, shardB, shardC, salt);
    ...
    function test_ValidTwoOfThreeSignature() public {
        ...
        AvyroAccount testAcc = new AvyroAccount(entryPoint, realShardA, realShardB, shardC);
    ...
    function test_WrongSignerRejected() public {
        ...
        address realShardA = vm.addr(keyA);
        AvyroAccount testAcc = new AvyroAccount(entryPoint, realShardA, shardB, shardC);
