...
const SAMPLE_NFTS: NftItem[] = [
  ...
  },
  {
    ...
    collectionName: "Avro Protocol Vault Keys",
    tokenId: "4663",
              ...
              <div className="p-4 flex flex-col flex-1 justify-between gap-3">
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-white/5">
                  <button
                    ...
                    className="flex-1 py-1.5 px-3 rounded-xl bg-[#3f3f46] hover:bg-[#52525b] text-white font-semibold text-xs flex items-center justify-center gap-1.5 transition cursor-pointer"
                  >
      ...
      {showSendModal && selectedNft && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4">
          <div className="w-full max-w-md bg-[#181a22] border border-white/[0.08] rounded-2xl p-5 flex flex-col gap-4 shadow-2xl">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-[#050505] border border-white/[0.06]">
              <img
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="p-2.5 rounded-xl bg-[#050505] border border-white/[0.08] text-white text-xs focus:outline-none focus:border-white/20"
              />
            </div>
            ...
            <button
              ...
              className={`w-full py-2.5 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer ${
                !recipient || !isAddress(recipient.trim()) || isSending
                  ...
                  : "bg-[#3f3f46] hover:bg-[#52525b] text-white"
              }`}
            >
              {isSending ? (
                <>
