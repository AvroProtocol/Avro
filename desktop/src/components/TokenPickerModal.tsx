      ...
      <div className="w-full max-w-md bg-[#181a22] border border-white/[0.08] rounded-2xl p-5 flex flex-col gap-4 shadow-2xl">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl bg-[#050505] border border-white/[0.08] text-white text-xs placeholder:text-neutral-500 focus:outline-none focus:border-white/20 transition"
          />
        </div>
        ...
        {showAddCustom && (
          <form
            ...
            className="p-3.5 rounded-xl bg-[#050505] border border-white/[0.08] flex flex-col gap-2.5 text-xs"
          >
            ...
            <button
              type="submit"
              className="mt-1 w-full py-2 px-3 rounded-lg bg-[#3f3f46] hover:bg-[#52525b] text-white font-semibold text-xs transition cursor-pointer"
            >
              Add Token
            </button>
          </form>
