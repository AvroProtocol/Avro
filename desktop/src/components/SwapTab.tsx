...
import { AvroWallet } from "@avro/protocol-sdk";
import { robinhoodChain } from "../lib/chain";

interface SwapTabProps {
  client: PublicClient;
  wallet: AvroWallet | null;
    ...
    <div className="flex flex-col items-center justify-center p-4 max-w-lg mx-auto w-full">
      <div className="w-full bg-[#181a22] border border-white/[0.08] rounded-2xl p-6 shadow-2xl flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 bg-[#050505] p-1 rounded-xl border border-white/[0.06] text-xs text-neutral-400">
            {[20, 50, 100].map((b) => (
              <button
                key={b}
        ...
        {/* Token In Box */}
        <div className="flex flex-col gap-1.5 p-4 rounded-xl bg-[#050505] border border-white/[0.06]">
        ...
        <div className="flex justify-center -my-2 z-10">
          <button
            onClick={flipTokens}
            className="p-2 rounded-xl bg-[#050505] hover:bg-white/10 border border-white/10 text-neutral-300 hover:text-white transition-all shadow-md active:scale-95 cursor-pointer"
          >
        ...
        {/* Quote Details */}
        {quote && (
          <div className="flex flex-col gap-1.5 p-3 rounded-xl bg-[#050505] border border-white/[0.06] text-xs text-neutral-400">
        ...
        <button
          ...
          className={`w-full py-3 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all shadow-lg cursor-pointer ${
            ...
            isKeyMismatch
              ...
              : "bg-[#3f3f46] hover:bg-[#52525b] text-white active:scale-[0.99]"
          }`}
        >
          {isSwapping ? (
            <>
