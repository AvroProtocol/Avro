    ...
    <>
      ...
      <div className="fixed bottom-12 right-6 z-30">
        <button
          ...
          className="group relative flex items-center gap-2 bg-[#121212] hover:bg-[#1a1a1a] text-white border border-white/10 hover:border-[#ffffff]/50 shadow-2xl rounded-full px-3.5 py-2 transition-all duration-200"
          title="Avyro Protocol Assistant (Ctrl+K)"
        >
