  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 max-w-lg mx-auto w-full">
      <div className="w-full bg-[#181a22] border border-white/[0.08] rounded-2xl p-6 shadow-2xl flex flex-col gap-4">
        ...
        {/* Route Selector Card */}
        <div className="flex items-center justify-between p-3.5 rounded-xl bg-[#050505] border border-white/[0.06] text-xs">
        ...
        <div className="flex flex-col gap-1.5 p-3.5 rounded-xl bg-[#050505] border border-white/[0.06]">
          <div className="flex items-center justify-between text-xs text-neutral-400">
        ...
        <div className="flex flex-col gap-2 p-3.5 rounded-xl bg-[#050505] border border-white/[0.06] text-xs text-neutral-400">
