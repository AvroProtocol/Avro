...
export async function processAssistantQuery(
  ...
  if (/^(hi|hello|hey|greetings|good\s+(morning|afternoon|evening))\b/i.test(lower)) {
    return await createResponse(
      "Hello! I am your Avro Protocol Assistant. How can I assist you today? You can command me to prepare transfers, generate payment links, check address safety, or inspect spending guardrails."
    );
  }
