#!/usr/bin/env python3
"""
Avro Public Repo Sync Script
================================
Syncs the local `master` branch to the public Open Source repository (AvroProtocol/Avro)
while rewriting all commit authors & committers to:
  Avro <dbantifun@gmail.com>
...
Keeps the primary `origin` (AvroProtocol/Avro) untouched for Lovable compatibility.
"""
...
PUBLIC_AUTHOR_NAME = "Avro"
PUBLIC_AUTHOR_EMAIL = "dbantifun@gmail.com"
