...
export function buildFactoryInitCode(
  ...
  factoryAddress: Address = AVYRO_FACTORY_ADDRESS
): Hex {
...
/**
 * Encodes calldata for sending ETH or USDG through AvyroAccount.execute
 */
...
/**
 * Submit signed UserOperation to the AVYRO bundler
 */
