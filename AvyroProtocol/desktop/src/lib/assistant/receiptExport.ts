/**
 * Verifiable Receipt Export & Offline Verifier - Avyro Protocol v0.1.20
 *
 * Turns an InferenceReceipt into a self-contained, optionally signed bundle that
 * a third party can check WITHOUT trusting Avyro Protocol.
 *
...
export const RECEIPT_BUNDLE_FORMAT = "avyro-receipt/1";
 ...
 * preimage attack.
 */
export const RECEIPT_DOMAIN_TAG = "AVYRO-INFERENCE-RECEIPT-v1\n";
...
export function receiptBundleFilename(receipt: InferenceReceipt): string {
  return `avyro-inference-receipt-${receipt.shortRef}.json`;
}
