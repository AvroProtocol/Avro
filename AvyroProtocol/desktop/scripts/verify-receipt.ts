#!/usr/bin/env bun
/**
 * Avyro Standalone Inference Receipt Verifier
 * ==============================================
 *
 * Checks an exported receipt bundle WITHOUT running, trusting, or contacting
 * the Avyro app. Everything is local: no network calls, no API, no keys.
 *
...
function printReport(report: VerificationReport, path: string, signerAvailable: boolean): void {
  ...
  console.log("");
  console.log(paint(BOLD, "Avyro Inference Receipt Verification"));
