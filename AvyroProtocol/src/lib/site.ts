 ...
 *
 * When unset we fall back to the canonical production domain so social cards
 * and canonical metadata still resolve correctly.
 */
...
const raw = import.meta.env["VITE_SITE_URL"]?.trim() || "https://avyroprotocol.com";

/** Canonical production origin with any trailing slash removed. */
export const SITE_URL = raw.replace(/\/+$/, "");

/** Absolute URL for `path`, using avyroprotocol.com as the production fallback. */
