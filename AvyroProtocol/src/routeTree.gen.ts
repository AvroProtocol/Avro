...
import { Route as AvyroRouteImport } from './routes/avyro'
...
const AvyroRoute = AvyroRouteImport.update({
  id: '/avyro',
  path: '/avyro',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/freeze' | '/mobile' | '/avyro' | '/docs' | '/pay/$slug'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/freeze' | '/mobile' | '/avyro' | '/docs' | '/pay/$slug'
  id: '__root__' | '/' | '/freeze' | '/mobile' | '/avyro' | '/docs' | '/pay/$slug'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/avyro': {
      ...
      path: '/avyro'
      fullPath: '/avyro'
      preLoaderRoute: typeof AvyroRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/docs': {
      id: '/docs'
