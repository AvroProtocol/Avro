...
const KEY_ACTIVE_ACCOUNT = "avyro_active_account";
const KEY_PREFIX_SHARD_A = "avyro_shard_a_";
const KEY_PREFIX_GUARDRAILS = "avyro_guardrails_";
const KEY_PREFIX_CONTACTS = "avyro_contacts_";
